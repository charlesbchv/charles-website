...
const ContactUs: React.FC = () => {
    ...
    return (
        ...
        {status.submitted ? (
            <div className='text-white text-xl font-bold px-4 py-3 rounded relative' role="alert">Your message has been successfully sent. We will contact you very soon!</div>
        ): (
    <>
                <input 
                    id="companyName" 
